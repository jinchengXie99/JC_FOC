...
{
    pFOC->id = pFOC->iα * fast_cos(pFOC->radian) + pFOC->iβ * fast_sin(pFOC->radian);
    pFOC->iq = -pFOC->iα * fast_sin(pFOC->radian) + pFOC->iβ * fast_cos(pFOC->radian);
}
...
{
    pFOC->iαSVPWM = pFOC->idPID.out * fast_cos(pFOC->radian) - pFOC->iqPID.out * fast_sin(pFOC->radian);
    pFOC->iβSVPWM = pFOC->idPID.out * fast_sin(pFOC->radian) + pFOC->iqPID.out * fast_cos(pFOC->radian);
}
